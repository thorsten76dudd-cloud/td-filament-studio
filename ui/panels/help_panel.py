...
class HelpPanel(ttk.Frame):
    def __init__(self, parent: tk.Misc) -> None:
        ...
        nb.add(tab_prog, text="  Programm-Anleitung  ")
        nb.add(tab_json, text="  JSON kvParam — alle Felder  ")
        nb.add(tab_mcode, text="  G-Code M-Befehle  ")
        ...
        ttk.Label(top, text="Suche Parameter:").pack(side="left")
        ...
        self.tree.heading("key", text="JSON-Schlüssel (kvParam)")
        self.tree.heading("desc", text="Bedeutung")
        ...
        ttk.Label(m_top, text="Suche M-Befehl:").pack(side="left")
        ...
        self.mcode_tree.heading("code", text="M-Befehl")
        self.mcode_tree.heading("desc", text="Bedeutung")
        ...
        hint = ttk.Label(
            tab_mcode,
            text="Marlin/Klipper + gängige Creality-Macros. Nicht jeder Befehl ist auf dem K2 aktiv.",
            style="Muted.TLabel",
            wraplength=900,
        )
